...
#' minimalist functions aimed to be userfriendly for folks without r knowledge\cr
...
#' given adjusted metrics, some michaela functions can estimate the partial correlation coefficient\cr
#' please use with caution: if you extracted adjusted metrics, make sure the function can actually estiamte partial correlation\cr
